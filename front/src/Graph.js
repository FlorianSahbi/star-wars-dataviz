    ...
    return (
      <nav className="filters">
        <div className="filterList">
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('I')}>
            Episode I
          </a>
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('II')}>
            Episode II
          </a>
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('III')}>
            Episode III
          </a>
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('IV')}>
            Episode IV
          </a>
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('V')}>
            Episode V
          </a>
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('VI')}>
            Episode VI
          </a>
          <a className="episodeBtn" onClick={() => this.onFilterMovieSelected('VII')}>
            Episode VII
          </a>
        </div>
      </nav>
